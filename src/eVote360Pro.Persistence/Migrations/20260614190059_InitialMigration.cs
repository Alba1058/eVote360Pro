    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EleccionesPuestos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EleccionesPuestos_Elecciones_EleccionId",
                        column: x => x.EleccionId,
                        principalTable: "Elecciones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EleccionesPuestos_PuestosElectivos_PuestoElectivoId",
            ...
            migrationBuilder.CreateTable(
                name: "AsignacionesCandidatoPuestos",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TipoCandidatura = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AsignacionesCandidatoPuestos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AsignacionesCandidatoPuestos_Candidatos_CandidatoId",
                        column: x => x.CandidatoId,
                        principalTable: "Candidatos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AsignacionesCandidatoPuestos_PartidosPoliticos_PartidoPoliticoId",
                        column: x => x.PartidoPoliticoId,
                        principalTable: "PartidosPoliticos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AsignacionesCandidatoPuestos_PuestosElectivos_PuestoElectivoId",
                        column: x => x.PuestoElectivoId,
                        principalTable: "PuestosElectivos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetalleVotos", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DetalleVotos_PuestosElectivos_PuestoElectivoId",
                        column: x => x.PuestoElectivoId,
                        principalTable: "PuestosElectivos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Partido1Id = table.Column<int>(type: "int", nullable: false),
                    Partido2Id = table.Column<int>(type: "int", nullable: false),
                    SolicitudAlianzaId = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AlianzasPoliticas_PartidosPoliticos_Partido1Id",
                        column: x => x.Partido1Id,
                        principalTable: "PartidosPoliticos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AlianzasPoliticas_PartidosPoliticos_Partido2Id",
                        column: x => x.Partido2Id,
                        principalTable: "PartidosPoliticos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AlianzasPoliticas_SolicitudesAlianzas_SolicitudAlianzaId",
                        column: x => x.SolicitudAlianzaId,
                        principalTable: "SolicitudesAlianzas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AlianzasPoliticas_Partido1Id",
                table: "AlianzasPoliticas",
                column: "Partido1Id");

            migrationBuilder.CreateIndex(
                name: "IX_AlianzasPoliticas_Partido2Id",
                table: "AlianzasPoliticas",
                column: "Partido2Id");

            migrationBuilder.CreateIndex(
                name: "IX_AlianzasPoliticas_SolicitudAlianzaId",
                table: "AlianzasPoliticas",
                column: "SolicitudAlianzaId");

            migrationBuilder.CreateIndex(
                name: "IX_AsignacionesCandidatoPuestos_CandidatoId",
                table: "AsignacionesCandidatoPuestos",
                column: "CandidatoId");

            migrationBuilder.CreateIndex(
                name: "IX_AsignacionesCandidatoPuestos_PartidoPoliticoId",
                table: "AsignacionesCandidatoPuestos",
                column: "PartidoPoliticoId");

            migrationBuilder.CreateIndex(
                name: "IX_AsignacionesCandidatoPuestos_PuestoElectivoId",
                table: "AsignacionesCandidatoPuestos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetalleVotos_PuestoElectivoId",
                table: "DetalleVotos",
                column: "PuestoElectivoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EleccionesPuestos_EleccionId",
                table: "EleccionesPuestos",
                column: "EleccionId");

            migrationBuilder.CreateIndex(
                name: "IX_EleccionesPuestos_PuestoElectivoId",
                table: "EleccionesPuestos",
                column: "PuestoElectivoId");
